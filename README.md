...
Repositorio para almacenar mis soluciones para las tareas del Proceso de software personal
...
Material de autoaprendizaje del PSP
Acerca del PSP (según Wikipedia)
El Proceso de Software Personal (PSP) es un proceso estructurado de desarrollo de software que está diseñado (planificado) para ayudar a los ingenieros de software a comprender y mejorar mejor su rendimiento mediante el seguimiento de su desarrollo de código previsto y real. El PSP fue creado por Watts Humphrey para aplicar los principios subyacentes del Modelo de Madurez de Capacidades (CMM) del Instituto de Ingeniería de Software (SEI) a las prácticas de desarrollo de software de un solo desarrollador. Afirma proporcionar a los ingenieros de software las habilidades de proceso necesarias para trabajar en un equipo de proceso de software en equipo (TSP).

Objetivos
El PSP tiene como objetivo proporcionar a los ingenieros de software métodos disciplinados para mejorar los procesos personales de desarrollo de software. El PSP ayuda a los ingenieros de software a:
...
Estructura del PSP
La formación en PSP sigue un enfoque de mejora evolutiva: un ingeniero que aprende a integrar el PSP en su proceso comienza en el primer nivel (PSP0) y progresa en la madurez del proceso hasta el nivel final (PSP2.1). Cada nivel cuenta con guiones detallados, listas de verificación y plantillas para guiar al ingeniero a través de los pasos necesarios y le ayuda a mejorar su propio proceso de software. Humphrey anima a los ingenieros competentes a personalizar estos guiones y plantillas a medida que comprenden sus propias fortalezas y debilidades
...
Estándares.
Formularios.
Los guiones del PSP proporcionan orientación a nivel experto para seguir los pasos del proceso y proporcionan un marco para aplicar las medidas del PSP. El PSP tiene cuatro medidas principales:
...
COQ de evaluación
Relación COQ de evaluación/fallo
...
Calidad
El objetivo del PSP es un software de alta calidad, y la calidad se mide en términos de defectos. Para el PSP, un proceso de calidad debe producir un software con pocos defectos que satisfaga las necesidades del usuario
...
Revisión de diseño.
Revisión de código.
Para realizar una revisión eficaz, es necesario seguir un proceso de revisión estructurado. El PSP recomienda el uso de listas de verificación para ayudar a los desarrolladores a seguir un procedimiento ordenado de forma consistente

El PSP parte de la premisa de que, cuando las personas cometen errores, estos suelen ser predecibles. Por lo tanto, los desarrolladores de PSP pueden personalizar sus listas de verificación para abordar sus propios errores comunes. También se espera que los ingenieros de software completen propuestas de mejora de procesos para identificar áreas débiles en su desempeño actual que deberían abordar. Los datos históricos del proyecto, que revelan dónde se invierte el tiempo y dónde se introducen los defectos, ayudan a los desarrolladores a identificar áreas de mejora.
